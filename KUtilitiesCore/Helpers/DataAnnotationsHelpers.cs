    ...
    internal static class DataAnnotationsHelpers
    {
            ...
            where TAttrib : Attribute
        {
            ...
            if (correctPropertyName.Contains('.'))
            {
                ...
                correctPropertyName = properties[properties.Length - 1]; // Actualizamos la propiedad que queremos trabajar
        ...
        internal static string GetDisplayFormatCore(Type sourceType, string propertyName)
        {
            ...
            else if (ret is not null) return ret.DataFormatString ?? string.Empty;
            return string.Empty;
        }
    ...
    where TAttrib : Attribute
        {
            MetadataTypeAttribute? meta = sourceType
                ...
                .FirstOrDefault();
            if (meta != null && meta.MetadataClassType != null)
            {
