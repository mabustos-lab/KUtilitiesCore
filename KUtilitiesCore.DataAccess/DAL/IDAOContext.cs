...
namespace KUtilitiesCore.DataAccess.DAL
{
    ...
    {       
        ...
        /// </summary>
        /// <param name="sql">La consulta SQL a ejecutar. Comando SELECT: se requieren las columnas clave.</param>
        ...
        /// <param name="selectCommandText">El comando SELECT con las columnas clave, utilizado para recuperar los datos originales.</param>
