...
{
    /// <summary>
    /// Interfaz base para repositorios de solo lectura.
    /// Define métodos para consultar entidades sin modificarlas.
    /// </summary>
    ...
    public interface IReadOnlyDbRepository<TEntity> where TEntity : class
    {
        ...
        /// La paginación no se aplica aquí; usar GetPagedAsync para resultados paginados.
        /// </summary>
        /// <param name="specification">La especificación que define los criterios de búsqueda, inclusiones y ordenación.</param>
        ...
        /// basada en una especificación y opciones de paginación.
        /// </summary>
